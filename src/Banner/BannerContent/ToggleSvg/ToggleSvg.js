...
import classes from "./ToggleSvg.module.css"

const ToggleSvg = ({open}) => {
    return (
        <div className={classes.Wrapper}>
            <svg width={"40"} aria-hidden="true" focusable="false" data-prefix="fas" data-icon="angle-down"
                 className="svg-inline--fa fa-angle-down fa-w-10" role="img" xmlns="http://www.w3.org/2000/svg"
                 viewBox="0 0 320 512" onClick={open}>
                <path fill="#ffd700"
